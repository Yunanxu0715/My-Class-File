...
class IO:
    ...
    @staticmethod
    def AddNewItemInList (list_of_rows):
    ...
    def DeleteItemInList (list_of_rows):
...
while(True):
    ...
    # Step 3.2 - Add a new item to the list/Table
        ...
        IO.AddNewItemInList(lstTable)
        IO.ShowCurrentItemsInList(lstTable)  # Show current data in the list/table
        continue  # to show the menu

    # Step 3.3 - Remove a new item to the list/Table
    elif(strChoice == '3'):
        IO.DeleteItemInList(lstTable) #delete items in the list/table
